    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            <div className="p-8 border-b border-brand-charcoal/5  flex justify-between items-center bg-brand-gold/5">
              <div>
                <h3 className="text-xl font-serif text-brand-charcoal ">Edit <span className="italic text-brand-gold">Properti</span></h3>
                <p className="text-[10px] text-brand-charcoal/40  uppercase tracking-widest font-bold mt-1">ID: {property.id}</p>
              </div>
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar scrollbar-hide">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input name="name" defaultValue={property.name} required className="w-full bg-brand-offwhite  border border-brand-charcoal/10  rounded-xl px-4 py-3 text-sm focus:ring-1 focus:ring-brand-gold outline-none " />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-brand-gold">Harga</label>
                  <input name="price" defaultValue={property.price} required className="w-full bg-brand-offwhite  border border-brand-charcoal/10  rounded-xl px-4 py-3 text-sm focus:ring-1 focus:ring-brand-gold outline-none " />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative group h-40 w-full bg-brand-offwhite  rounded-2xl overflow-hidden border-2 border-dashed border-brand-gold/10">
                    {imagePreview && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <select name="category" defaultValue={property.category} className="w-full bg-brand-offwhite  border border-brand-charcoal/10  rounded-xl px-4 py-3 text-sm focus:ring-1 focus:ring-brand-gold outline-none ">
                  ...
                  <div className="space-y-2">
                    ...
                    <select name="status" defaultValue={property.status} className="w-full bg-brand-offwhite  border border-brand-charcoal/10  rounded-xl px-4 py-3 text-sm focus:ring-1 focus:ring-brand-gold outline-none ">
                ...
                <div className="space-y-2">
                  ...
                  <textarea name="description" defaultValue={property.description} rows={3} className="w-full bg-brand-offwhite  border border-brand-charcoal/10  rounded-xl px-4 py-3 text-sm focus:ring-1 focus:ring-brand-gold outline-none  resize-none" />
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="space-y-2">
                    ...
                    <input name="luas_tanah" type="number" defaultValue={property.luas_tanah} className="w-full bg-brand-offwhite  border border-brand-charcoal/10  rounded-xl px-4 py-3 text-sm focus:ring-1 focus:ring-brand-gold outline-none " />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <input name="luas_bangunan" type="number" defaultValue={property.luas_bangunan} className="w-full bg-brand-offwhite  border border-brand-charcoal/10  rounded-xl px-4 py-3 text-sm focus:ring-1 focus:ring-brand-gold outline-none " />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold uppercase tracking-widest text-brand-gold">Kamar Tidur</label>
                    <input name="kamar_tidur" type="number" defaultValue={property.kamar_tidur} className="w-full bg-brand-offwhite  border border-brand-charcoal/10  rounded-xl px-4 py-3 text-sm focus:ring-1 focus:ring-brand-gold outline-none " />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold uppercase tracking-widest text-brand-gold">K. Mandi</label>
                    <input name="kamar_mandi" type="number" defaultValue={property.kamar_mandi} className="w-full bg-brand-offwhite  border border-brand-charcoal/10  rounded-xl px-4 py-3 text-sm focus:ring-1 focus:ring-brand-gold outline-none " />
                  </div>
                </div>

                <div className="space-y-2">
                  <label className="text-[10px] font-bold uppercase tracking-widest text-brand-gold">URL Video (Opsional)</label>
                  <input name="video_url" defaultValue={property.video_url} className="w-full bg-brand-offwhite  border border-brand-charcoal/10  rounded-xl px-4 py-3 text-sm focus:ring-1 focus:ring-brand-gold outline-none " />
                </div>
                ...
                <div className="pt-6 flex gap-4">
                  <button
                    type="button"
                    onClick={onClose}
                    className="flex-1 py-4 border border-brand-charcoal/10  text-brand-charcoal/60  text-[10px] font-bold uppercase tracking-widest rounded-2xl hover:bg-brand-charcoal/5 transition-all"
                  >
                    Batal
                  </button>
                  <button
