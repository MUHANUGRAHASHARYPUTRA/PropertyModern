...
import { Home, Instagram, Facebook, Youtube, Twitter } from 'lucide-react';
    ...
    <footer className="bg-brand-charcoal text-brand-ivory pt-20 pb-10 border-t-4 border-brand-gold">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-brand-ivory/70">
              ...
              <li><a href="#" className="hover:text-brand-gold transition-colors">FAQ KPR</a></li>
          ...
          <div>
            ...
            <form className="flex mb-8" onSubmit={e => e.preventDefault()}>
              <input 
                ...
                className="bg-brand-ivory/10 border border-brand-ivory/20 px-4 py-2 w-full focus:outline-none focus:border-brand-gold text-sm rounded-l-md"
              />
              <button className="bg-brand-gold px-4 py-2 text-white text-sm font-medium rounded-r-md hover:bg-brand-gold/90 transition-colors">
                Daftar
              </button>
            </form>

            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-brand-ivory/10 flex items-center justify-center hover:bg-brand-gold hover:scale-110 transition-all group" title="Instagram">
                <Instagram className="w-5 h-5 text-brand-ivory group-hover:text-white" />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-brand-ivory/10 flex items-center justify-center hover:bg-[#1877F2] hover:scale-110 transition-all group" title="Facebook">
                <Facebook className="w-5 h-5 text-brand-ivory group-hover:text-white" />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-brand-ivory/10 flex items-center justify-center hover:bg-[#FF0000] hover:scale-110 transition-all group" title="YouTube">
                <Youtube className="w-5 h-5 text-brand-ivory group-hover:text-white" />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-brand-ivory/10 flex items-center justify-center hover:bg-black hover:scale-110 transition-all group" title="TikTok">
        ...
        <div className="border-t border-brand-ivory/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-brand-ivory/50">
          <p>&copy; {new Date().getFullYear()} Grand Estate. All rights reserved.</p>
