    ...
    <section id="home" className="relative w-full h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-6 md:px-12 flex flex-col items-center text-center mt-20">
        ...
        >
          ...
          {/* Search Bar */}
          <motion.div variants={itemVariants} className="w-full max-w-3xl bg-brand-ivory/95 backdrop-blur-md dark:bg-brand-dark-surface/95 p-2 md:p-2 rounded-full shadow-2xl flex flex-col md:flex-row gap-2 md:gap-4 items-center border border-brand-gold/20">
            <div className="flex-1 flex items-center gap-3 px-6 py-3 w-full border-b md:border-b-0 md:border-r border-brand-charcoal/10 dark:border-brand-ivory/10">
            ...
            <div className="flex-1 flex items-center gap-3 px-6 py-3 w-full">
              ...
              <select className="w-full bg-transparent border-none outline-none text-brand-charcoal dark:text-brand-ivory appearance-none cursor-pointer font-medium">
            ...
            <button className="w-full md:w-auto px-8 py-4 bg-brand-gold text-white font-medium rounded-full hover:bg-brand-gold/90 transition-colors flex items-center justify-center gap-2">
